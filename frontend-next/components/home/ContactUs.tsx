...
const INPUT_CLASS =
  "input-glow rounded-lg border border-surface-border bg-surface-container-lowest px-4 py-3 text-body-md text-primary focus:border-primary focus:outline-none transition-colors";
      ...
      <div className="max-w-container-max mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-5">
          ...
          <p className="text-body-lg font-body-lg text-text-secondary mb-8">
            For recruitment, internships, or collaboration enquiries, reach out to
            the Training &amp; Placement Cell. Our team will respond promptly.
          </p>
            ...
            {CONTACT_DETAILS.map((item) => (
              <div key={item.label} className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="text-body-md font-body-md text-primary">
                    {item.value}
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div className="flex flex-col gap-1.5">
                <label
                  ...
                  className="text-label-md font-label-md text-text-secondary uppercase tracking-wider"
                >
                  Full Name
                </label>
                <input
