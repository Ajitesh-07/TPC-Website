...
export interface CalendarEvent {
  ...
  /** ISO 'YYYY-MM-DD'. */
  date: string;
  /** 'HH:MM' — omit for all-day events (deadlines/results). */
  start?: string;
  /** 'HH:MM'. */
  end?: string;
  location?: string;
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="p-1 rounded hover:bg-surface-container text-text-secondary"
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-1 mt-auto">
                    {dayEvents.slice(0, 3).map((e) => (
                      <span
                        key={e.id}
                        className={`w-1.5 h-1.5 rounded-full ${EVENT_CONFIG[e.type].dot}`}
                        title={e.title}
                      ></span>
                    ))}
                    {dayEvents.length > 3 && (
          ...
          <div className="p-5 border-b border-surface-border flex justify-between items-center bg-surface/50 backdrop-blur-sm">
            ...
            {selectedDay && (
              <button
                ...
                className="text-label-sm font-label-sm text-primary hover:text-navy-vibrant"
              >
                Clear
              </button>
            )}
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-3 custom-scrollbar max-h-[60vh]">
            {listedEvents.length === 0 ? (
              ...
              listedEvents.map((ev) => (
                <div
                  key={ev.id}
                  className="p-4 rounded-lg border border-surface-border bg-surface-container-low hover:shadow-md transition-shadow"
                >
          ...
          >
            <div className="flex justify-between items-center">
              ...
              <button
                ...
                className="w-9 h-9 rounded-full hover:bg-surface-variant flex items-center justify-center text-text-secondary"
                aria-label="Close"
              >
            ...
            <div>
              <label className="block text-label-sm font-label-sm text-text-secondary mb-1" htmlFor="title">
                Title
              </label>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-label-sm font-label-sm text-text-secondary mb-1" htmlFor="type">
                  Type
                </label>
              ...
              <div>
                <label className="block text-label-sm font-label-sm text-text-secondary mb-1" htmlFor="date">
                  Date
                </label>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-label-sm font-label-sm text-text-secondary mb-1" htmlFor="start">
                  Start (optional)
                </label>
                <input id="start" name="start" type="time" className={inputClass} />
              </div>
              <div>
                <label className="block text-label-sm font-label-sm text-text-secondary mb-1" htmlFor="end">
                  End (optional)
                </label>
            ...
            <div>
              <label className="block text-label-sm font-label-sm text-text-secondary mb-1" htmlFor="location">
