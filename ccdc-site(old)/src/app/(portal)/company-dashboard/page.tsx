...
const CompanyDashboard = () => {
  return (
    <div className="flex-1 p-gutter-mobile md:p-gutter-desktop max-w-container-max mx-auto w-full">
      {/* HR Profile Banner (Modern, Glassmorphic) */}
          ...
          <div className="flex flex-col md:flex-row items-center md:items-end gap-6 md:absolute md:bottom-6 md:left-6">
            <div className="w-24 h-24 rounded-full border-4 border-white shadow-md bg-white overflow-hidden relative z-10 shrink-0">
              <img 
                ...
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuBWyecKY1tZpSOBiDCwB_MDiiIJYPynz7AYTvYSwRHELaPAIZMFUnf8jP2__cOWwXXm_lGbBPnXvoSirTeqyipT4cPuJ4DZFpY71pLGDuTfEsL7s03AO4UEByMrE-BLq9efz9xSvhoKT2YEGlaaqKdzxQ6tpl4fxV9822mZ9K4_bYgG1MQas3UYS4ED3oMMJdUsu6KzZJKTfGrZ7d-3MioZc8G6ZWo5s6tzcA8o3-xNlghKjrlNFNDnVhnFtom69BQsTwaMNEYp_jCf" 
              />
            </div>
            <div className="text-center md:text-left md:mb-1 z-10 md:ml-[110px]">
              <h1 className="text-headline-md font-headline-md text-text-primary mb-1">TechFlow Solutions Inc.</h1>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-surface-container-lowest rounded-xl p-6 border border-surface-border shadow-[0_4px_20px_rgba(0,0,0,0.04)] flex flex-col justify-between h-full relative overflow-hidden group hover:border-primary-fixed-dim transition-colors">
          ...
          <div>
            <p className="text-label-sm font-label-sm text-text-secondary uppercase tracking-wider mb-2">Total Applicants</p>
            <h2 className="text-display-lg font-display-lg text-text-primary">1,248</h2>
          </div>
        ...
        <div className="bg-surface-container-lowest rounded-xl p-6 border border-surface-border shadow-[0_4px_20px_rgba(0,0,0,0.04)] flex flex-col justify-between h-full relative overflow-hidden group hover:border-primary-fixed-dim transition-colors">
          ...
          <div>
            <p className="text-label-sm font-label-sm text-text-secondary uppercase tracking-wider mb-2">Ongoing Drives</p>
        ...
        <div className="bg-primary-container text-on-primary-container rounded-xl p-6 shadow-[0_4px_20px_rgba(0,0,0,0.04)] flex flex-col justify-between h-full relative overflow-hidden">
          ...
          <div>
            <p className="text-label-sm font-label-sm text-primary-fixed-dim uppercase tracking-wider mb-2">Quick Actions</p>
            <h3 className="text-title-lg font-title-lg text-white mb-4">Job Descriptions</h3>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
        ...
        <section className="lg:col-span-2 bg-surface-container-lowest rounded-xl border border-surface-border shadow-[0_4px_20px_rgba(0,0,0,0.04)] p-6">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-title-lg font-title-lg text-text-primary">Campus Itinerary</h3>
            <button className="text-primary text-label-md font-label-md font-medium hover:underline flex items-center gap-1">
              Full Schedule <span className="material-symbols-outlined text-[16px]">chevron_right</span>
            </button>
          </div>
          <div className="relative border-l-2 border-surface-variant ml-3 space-y-8 pb-4">
            {/* Timeline Item 1 */}
            <div className="relative pl-8">
              <div className="absolute w-4 h-4 rounded-full bg-primary border-4 border-white -left-[9px] top-1 shadow-sm"></div>
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-2">
                <div>
                  <h4 className="text-title-md font-title-md text-text-primary">Pre-Placement Talk (PPT)</h4>
                  <p className="text-body-md font-body-md text-text-secondary mt-1">Senate Hall, Admin Block</p>
                  <div className="mt-2 inline-flex items-center gap-1 px-2 py-1 rounded bg-secondary-fixed text-on-secondary-fixed text-label-sm font-label-sm">
                    <span className="material-symbols-outlined text-[14px]">groups</span> SDE Role
                  </div>
                </div>
                <div className="text-left md:text-right shrink-0">
                  <span className="block text-label-md font-label-md text-text-primary font-bold">Oct 15, 2024</span>
                  <span className="block text-label-sm font-label-sm text-text-secondary mt-1">10:00 AM - 11:30 AM</span>
                </div>
              </div>
            </div>
            ...
            {/* Timeline Item 2 */}
            <div className="relative pl-8">
              <div className="absolute w-4 h-4 rounded-full bg-surface-variant border-4 border-white -left-[9px] top-1 shadow-sm"></div>
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-2">
                <div>
                  <h4 className="text-title-md font-title-md text-text-primary">Online Assessment</h4>
                  <p className="text-body-md font-body-md text-text-secondary mt-1">Computer Center Lab 1 &amp; 2</p>
                </div>
                <div className="text-left md:text-right shrink-0">
                  <span className="block text-label-md font-label-md text-text-primary font-bold">Oct 16, 2024</span>
                  <span className="block text-label-sm font-label-sm text-text-secondary mt-1">09:00 AM - 12:00 PM</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative pl-8">
              ...
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-2">
                <div>
                  <h4 className="text-title-md font-title-md text-text-primary">Technical Interviews (Round 1)</h4>
                  <p className="text-body-md font-body-md text-text-secondary mt-1">Virtual / Block 3 Rooms</p>
                </div>
                <div className="text-left md:text-right shrink-0">
                  <span className="block text-label-md font-label-md text-text-primary font-bold">Oct 18, 2024</span>
                  <span className="block text-label-sm font-label-sm text-text-secondary mt-1">Starts at 10:00 AM</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="bg-surface-container-lowest rounded-xl border border-surface-border shadow-[0_4px_20px_rgba(0,0,0,0.04)] p-6">
          <h3 className="text-title-lg font-title-lg text-text-primary mb-6">Recent Activity</h3>
          <ul className="space-y-4">
            <li className="flex gap-4">
              ...
              <div>
                <p className="text-body-md font-body-md text-text-primary"><span className="font-semibold">SDE Role</span> JD approved by CDC.</p>
                <span className="text-label-sm font-label-sm text-text-secondary mt-1 block">2 hours ago</span>
              </div>
            </li>
            <li className="flex gap-4">
              ...
              <div>
                <p className="text-body-md font-body-md text-text-primary">New student registered for <span className="font-semibold">Data Analyst</span>.</p>
                <span className="text-label-sm font-label-sm text-text-secondary mt-1 block">5 hours ago</span>
              </div>
            </li>
            <li className="flex gap-4">
              ...
              <div>
                <p className="text-body-md font-body-md text-text-primary">Action required: Confirm PPT slot for Oct 15.</p>
                <span className="text-label-sm font-label-sm text-text-secondary mt-1 block">1 day ago</span>
              </div>
            </li>
          </ul>
        </section>
