...
const AboutTPC = () => {
  return (
    <section id="about" className="py-24 px-gutter-desktop bg-surface-container-lowest">
      <div className="max-w-container-max mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        <div className="lg:col-span-5">
          ...
          <p className="text-body-lg font-body-lg text-text-secondary mb-5">
            The Training &amp; Placement Cell of IIT Patna serves as the central link
            between our students and the corporate world. We facilitate internships,
            full-time placements, and pre-placement engagements across every academic
            programme.
          </p>
          <p className="text-body-md font-body-md text-text-secondary">
            ...
            empower every student with the opportunities, guidance, and transparent
            processes needed to launch a meaningful career — while giving recruiters
            seamless access to one of India's most rigorous engineering talent pools.
          </p>
        </div>
        ...
        <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-3 gap-6">
          {PILLARS.map((pillar) => (
            ...
            >
              ...
              <h3 className="text-title-md font-title-md text-primary mb-2">{pillar.title}</h3>
              <p className="text-body-md font-body-md text-text-secondary">{pillar.desc}</p>
            </div>
          ))}
        </div>
      </div>
