// Campus image doubles as the video poster until a real placement reel is dropped
// into /public (set VITE-friendly path below). Video is muted + looping per brief.
const POSTER_IMAGE =
...
const Hero = () => {
  return (
    <section className="relative w-full h-[819px] min-h-[600px] flex items-center justify-center overflow-hidden">
      {/* Background video (muted, looping, no controls). Falls back to poster image
          until /placement-reel.mp4 is added to the public/ folder. */}
      ...
      <div className="relative z-10 text-center px-gutter-desktop md:max-w-container-max mx-auto w-full flex flex-col items-center">
        ...
        <h1 className="text-display-lg font-display-lg text-on-primary mb-6 max-w-4xl tracking-tight leading-tight">
          Empowering Innovation,<br />Engineering the Future.
        </h1>
        <p className="text-body-lg font-body-lg text-tertiary-fixed-dim max-w-2xl mb-10">
          Connecting world-class talent with global industry leaders. Discover the
          minds shaping tomorrow's technology landscape at IIT Patna.
        </p>
